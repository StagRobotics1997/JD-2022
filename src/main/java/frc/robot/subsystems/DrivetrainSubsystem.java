...
public class DrivetrainSubsystem extends SubsystemBase {
    ...
    private static final double FRONT_LEFT_ANGLE_OFFSET = -Math.toRadians(214.2);
    private static final double FRONT_RIGHT_ANGLE_OFFSET = -Math.toRadians(65.5);
    private static final double BACK_LEFT_ANGLE_OFFSET = -Math.toRadians(347.3);
    private static final double BACK_RIGHT_ANGLE_OFFSET = -Math.toRadians(337.0);
